        ...
        try:
            ...
            for id_cliente, nombre, telefono, direccion in clientes:
                self.clientes_data[nombre] = {
                    'Teléfono': telefono,
                    'Dirección': direccion,
                    'Localidad': '',  # Por ahora vacío, podés agregar en DB si querés
                }
            ...
            # Ejemplo estático:
            self.proveedor_dropdown.addItems(['Proveedor 1', 'Proveedor 2', 'Proveedor 3'])

        except Exception as e:
            QMessageBox.critical(self, "Error", f"No se pudo cargar los datos desde la base de datos: {e}")
    ...
    def generar_documento(self):
        ...
        try:
            ...
            if cliente_id is None:
                agregar_cliente(cliente, self.telefono_input.text(), self.direccion_input.text())
            ...
            QMessageBox.warning(self, "Error Base de Datos", f"No se pudo guardar el presupuesto: {e}")
